...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (proof-general yasnippet-snippets yasnippet which-key use-package rainbow-delimiters paredit markdown-mode magit haskell-mode google-this geiser ess dart-mode clojure-snippets clojure-quick-repls clojure-mode-extra-font-locking clojure-cheatsheet beacon ace-window)))
 '(quack-programs
   (quote
